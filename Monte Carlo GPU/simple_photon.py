...
def polarized_photon_linear(seed, incident_degree, n, reflection, zstokes, random_nums, U, W, jones, mu_as,
                            mu_ss, s1, s2, m11, m12, scat_events, jones_partial, thread_idx):
...
def process_steps_linear(seed, incident_degree, n, reflection, zstokes, random_nums, U, W, jones, mu_as, mu_ss, scat_events, jones_partial, s1, s2, m11, m12,
                         ):
